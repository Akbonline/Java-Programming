...
import cnt5106c.conf.CommonProperties;
import cnt5106c.conf.RemotePeerInfo;
import cnt5106c.log.EventLogger;
import cnt5106c.log.LogHelper;
...
public class PeerManager implements Runnable {
    ...
    //Constructor to initialize a new peer with default values:
